...
export function AppPreloader() {
  ...
  useEffect(() => {
    // Smooth progress counter reaching 100%
    ...
    <AnimatePresence mode="wait">
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 z-[999999] flex flex-col items-center justify-center bg-[#FAF7F2] dark:bg-[#18181B] text-zinc-950 dark:text-white select-none p-6"
        >
          {/* Subtle Ambient Radial Glow */}
          <div className="absolute w-[500px] h-[500px] bg-gradient-to-tr from-amber-500/10 via-indigo-500/10 to-purple-500/10 rounded-full blur-[120px] pointer-events-none" />

          <div className="relative z-10 flex flex-col items-center justify-center space-y-8 max-w-sm w-full text-center">
            
            {/* Uiverse Typographic SVG Loader Spans */}
            <div className="uiverse-loader py-4">
              <span className="l">
                <svg
            ...
            {/* Micro Progress Bar & Branding Tag */}
            <div className="w-full space-y-2 pt-2">
              <div className="w-36 h-1.5 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden mx-auto">
                <motion.div
              ...
              <div className="text-[11px] font-mono tracking-widest text-zinc-500 dark:text-zinc-400 uppercase">
                WORKROOM STUDIO
              </div>
            </div>
