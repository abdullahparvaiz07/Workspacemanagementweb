        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center items-start">
            ...
            <h2 className="font-serif-title text-5xl sm:text-6xl lg:text-7xl font-normal text-zinc-950 leading-[1.05] tracking-tight">
              Too many places. <br />
              <span className="block">Not enough clarity.</span>
            </h2>
            ...
            <div className="mt-10 w-full max-w-md relative pt-2 pb-6">
              ...
              <div className="flex items-center justify-between gap-3 sm:gap-4 relative z-10">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-2xl border border-zinc-200 shadow-sm flex items-center justify-center p-3 hover:shadow-md transition-shadow">
                    <svg viewBox="0 0 127.14 127.14" className="w-8 h-8">
                  ...
                  <span className="text-xs font-medium text-zinc-600">Slack</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-zinc-600">Figma</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-zinc-600">Sheets</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-zinc-600">Drive</span>
                </div>
              ...
              <div className="relative w-full h-28 mt-2">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-[38px] pointer-events-none select-none text-center">
                  <span className="font-handwriting text-2xl sm:text-3xl text-zinc-800 font-medium tracking-wide leading-tight block">
                    Scattered work.
                  </span>
                </div>
              </div>
          ...
          <div className="lg:col-span-7 flex justify-center items-center -mt-8 lg:-mt-20">
            <Image
